...
cp  -r  "$HOME"/.config/copyq        /mnt/Disk_D/Muhammad/Repositories/DotFiles/.config/
...
cp  -r  "$HOME"/.config/hypr         /mnt/Disk_D/Muhammad/Repositories/DotFiles/.config/
...
cp  -r  "$HOME"/.config/qt5ct        /mnt/Disk_D/Muhammad/Repositories/DotFiles/.config/
